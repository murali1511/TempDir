          ...
          <v-container>
            ...
            <v-card class="glass rounded-2xl elevation-4 mb-10">
              <v-card-text>
                ...
                <!-- Arch contents / sections from JSON -->
                <v-row>
                  <v-col cols="12">
                    <div class="text-subtitle-1 font-weight-bold mb-2">
                      Architecture Featurs
                    </div>
                    <v-expansion-panels variant="default " multiple class="rounded-xl">
                      <v-expansion-panel
                        v-for="(s, i) in architectureDetails.details || []"
                        :key="i"
                      >
                  ...
                  <v-col cols="12" class="mt-5">
                    ...
                    <v-expansion-panels variant="default " multiple class="rounded-xl">
                      <v-expansion-panel
                        v-for="(s, i) in arch_features[0].features || []"
                        :key="i"
                      >
                        <v-expansion-panel-title color="#f2dfa7">
                          <v-icon class="mr-2" :color="s.present ? 'green' : 'red'">{{
                            s.present ? "mdi-check-circle" : "mdi-close-circle"
                          }}</v-icon>
                          {{ s.name }}
                        </v-expansion-panel-title>
                        <v-expansion-panel-text class="text-boady-2">
...
import { arch_features } from "@/stores/architecture_features.js";
...
const architectureDetails = {
  ...
  details: [
    ...
    {
      head: "Koothambalam / Minor deities",
      items: [
        "At Lokanarkavu Temple, Goddess Durga, revered as Bhagavathi, represents power, wisdom, and protection. She is worshipped as both a compassionate mother and a fierce protector. The deity here holds a unique connection with Kerala’s martial traditions, particularly through the legendary warrior Thacholi Othenan, who sought her blessings before battles. This association makes Lokanarkavu a spiritual center for those seeking courage and victory.",
        "What sets this temple apart are the tantric rituals and the Vellattam ritual, a vibrant dance offering performed during festivals, celebrating Bhagavathi’s dynamic energy. The serene ambiance of the temple, adorned with intricate murals depicting mythological tales, enhances the devotional experience.",
        "Devotees come to Lokanarkavu to seek her blessings for strength, protection, and prosperity. The temple’s rich blend of spirituality, mythology, and cultural heritage makes it a distinctive and revered place of worship for Goddess Durga.",
      ],
    },
  ],
};

console.log(arch_features[0].features);
watchEffect(() => {
