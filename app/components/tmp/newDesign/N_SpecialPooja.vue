                ...
                <v-row>
                  <v-col cols="12">
                    ...
                    <v-expansion-panels variant="default " multiple class="rounded-xl">
                      <v-expansion-panel
                        v-for="(s, i) in localStore.specialpoojas.specialpooja || []"
                        :key="i"
                      >
                        <v-expansion-panel-title color="#f2dfa7">
                          <v-icon class="mr-1" v-if="$vuetify.display.smAndUp"
                            >mdi-oil-lamp</v-icon
                          >
                          <span
                            :class="
                        ...
                        <v-expansion-panel-text class="text-body-2">
                          ...
                          <v-row>
                            <v-list lines="full">
                              <v-list-item
                                v-for="(entry, index) in s.details"
                                :key="index"
                              >
                                <v-icon color="red mr-2 mb-1 mt-1"
...
// sample data - in real app, fetch from API or local JSON file
...
console.log(localStore.specialpoojas);
