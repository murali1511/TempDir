        ...
        <v-card class="rounded-2xl overflow-hidden elevation-6">
          ...
          <v-container>
            ...
            <v-card class="glass rounded-2xl elevation-4 mb-10">
              <v-card-text>
                <div
                  v-html="Temples_Facilities[0].temple.description"
                  :class="
                ...
                <!-- Facilities contents / sections from JSON -->
                <v-row>
                  <div
                    v-for="(facilities, i) in Temples_Facilities[0]
                      .accessibility_and_facilities || []"
                    :key="i"
                  >
                    <v-col cols="12" class="s">
                      <div class="text-subtitle-1 font-weight-bold mb-2">
                        {{ facilities.category }}
                      </div>
                      <v-expansion-panels variant="default " multiple class="rounded-xl">
                        <v-expansion-panel
                          v-for="(s, i) in facilities.features || []"
                          :key="i"
                        >
...
console.log(Temples_Facilities[0].accessibility_and_facilities);
watchEffect(() => {
