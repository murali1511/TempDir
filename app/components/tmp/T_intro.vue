  ...
  <v-theme-provider theme="dark">
    <v-row>
      <v-col>
        <v-card
          :class="[
            'mx-auto rounded-lg g_border justify-center',
            $vuetify.display.smAndUp ? 'ml-8 mr-8' : '',
          ]"
          :color="colorScheme[1]"
          v-bind="props"
          max-width="800"
        >
          <v-card-title
            class="d-flex justify-space-between align-center grab"
            :style="`color: ${colorScheme[0]}`"
            :class="$i18n.locale.value == 'ml' ? 'text-caption' : 'text-subtitle-2'"
          >
              ...
              <v-card-text class="py-2 px-4">
                <div class="text-container">
                  ...
                  <v-img
                    ...
                    height="100"
                    width="100"
                    class="rounded mx-auto d-flex justify-center align-center"
